      ...
      <div className="py-32">
        <div className="gap-7">
          ...
          <div className="text-xl font-bold py-5 mr-3">
            <p>
              <b className="text-red-500 text-2xl">HUNGRY?</b> Just wait
            </p>
            <p>food at your door</p>
          </div>
        </div>
        <div className="flex gap-5">
          <button className=" bg-emerald-500 px-8 py-2 hover:bg-red-500 hover:font-bold">
            Order now
          </button>
          <Link to={"/food"}>
            {" "}
            <button className="border-2 px-8 py-2 hover:text-red-500 border-red-600">
              See all foods
            </button>
          </Link>
        </div>
